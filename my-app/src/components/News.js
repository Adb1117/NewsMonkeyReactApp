        ...
        return (
            <div className="container my-3">
                ...
                <div className="row"> 
                    ...
                    <div className="col-md-4">
                        <NewsItem title="myTitle" description="mydesc" imageUrl="https://live-production.wcms.abc-cdn.net.au/1006c7ecf34ec0935eef2aade5017711?impolicy=wcms_crop_resize&cropH=2815&cropW=5004&xPos=0&yPos=223&width=862&height=485" newsUrl="TODO"/>
                    </div>
                    <div className="col-md-4">
